...
const membershipstripePaymentSchema = new mongoose.Schema({
  ...
  membership_id: { type: mongoose.Schema.Types.ObjectId, default: null, ref: "Membership" },
  date: { type: String },
  createdAt: { type: Date, default: Date.now }
});

//  Compiling Schema
const MembershipStrpiePaymentModel = mongoose.model("MembershipStripePayment", membershipstripePaymentSchema);
